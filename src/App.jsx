...
const faqs = ['What services does Aarnex Tech provide?', 'How long does a project typically take?', 'Do you provide custom solutions?', 'Are your solutions scalable?', 'Do you provide after-sales support?'];

const scrollTo = (id) => document.getElementById(id)?.scrollIntoView({ behavior: 'smooth', block: 'start' });

function Brand() {
  return <a className="brand" href="#home" onClick={(event) => { event.preventDefault(); scrollTo('home'); }}><img src={logo} alt="Aarnex Tech" /></a>;
}
...
function Dashboard() {
  return <div className="dashboard-wrap corporate-visual" aria-label="Aarnex Tech innovation preview">
    <div className="visual-caption"><span>Aarnex Tech</span><b>Technology for<br/>what&apos;s next.</b></div>
