...
export default function Navbar() {
  ...
  return (
    <nav className="site-nav" style={{
      ...
      <ul className={menuOpen ? 'nav-links open' : 'nav-links'} style={{display:'flex',gap:'2px',listStyle:'none'}}>
        {links.map(l => (
          <li key={l}>
            <a href={`#${l}`}
      ...
      <a className="nav-quote" href="#contact" onClick={e=>{e.preventDefault();scrollTo('contact')}} style={{
