...
export default function Footer() {
  ...
  return (
    <footer className="site-footer" style={{background:'#060d1a',borderTop:'1px solid rgba(0,200,255,.08)',padding:'1.8rem 5%',display:'flex',alignItems:'center',justifyContent:'space-between',flexWrap:'wrap',gap:'1.2rem'}}>
