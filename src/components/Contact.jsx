...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={ref} className="contact-section" style={{padding:'7rem 5%',background:'#080f1e'}}>
      <div className="contact-grid" style={{display:'grid',gridTemplateColumns:'1fr 1.25fr',gap:'4rem',alignItems:'start'}}>
        ...
        <div className="reveal d1">
          <div style={{background:'#0d1a2e',border:'1px solid rgba(0,200,255,.08)',borderRadius:'20px',padding:'2.4rem 2rem',position:'relative',overflow:'hidden'}}>
            ...
            <div className="contact-name-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'.65rem',marginBottom:'.65rem'}}>
