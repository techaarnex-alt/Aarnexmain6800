...
export default function Hero() {
  ...
  return (
    <section id="home" className="hero" style={{minHeight:'100vh',padding:'66px 5% 0',display:'flex',flexDirection:'column',justifyContent:'center',position:'relative',overflow:'hidden'}}>
      <style>{`
...
>
        ...
        {/* RIGHT PANEL */}
        <div className="hero-visual" style={{background:'#0d1a2e',border:'1px solid rgba(0,200,255,.18)',borderRadius:'18px',overflow:'hidden',position:'relative'}}>
